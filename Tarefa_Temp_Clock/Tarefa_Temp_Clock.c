...
bool repeating_timer_callback(struct repeating_timer *t) {
    switch (state) {
        case 0:  // Liga amarelo, desliga os outros 
            ...
            state = 1;
            break;
        case 1: // Liga verde, desliga os outros 
            ...
            state = 2;
            break;
        case 2: // Liga vermelho, desliga os outros
...
int main() {
    ...
    // Configurando o temporizador para alternar a cada 3 segundos
